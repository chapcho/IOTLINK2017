...
namespace NewIOMaker.Form.Form_MultiCopy
{
    public partial class MCKey : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        protected CheckState _FirstCheck;
        protected CheckState _SecondCheck;
        protected string _dbColumn = "Key Order";

        public event delKeyListInputAfter EventKeyListUpdate;
        public event delMultiCopyKey EventGenerateKeyClick;
        ...
        void btnKeyRegister_Click(object sender, EventArgs e)
        {
            ...
            _FirstCheck = FirstKey.CheckState;
            _SecondCheck = SecondKey.CheckState;
            EventGenerateKeyClick(_FirstCheck, _SecondCheck);
        ...
        void userText_Click(object sender, EventArgs e)
        {
            userText.EditValue = "";
        }

        void btnTextAdd_Click(object sender, EventArgs e)
        {
            string sKey = string.Empty;
