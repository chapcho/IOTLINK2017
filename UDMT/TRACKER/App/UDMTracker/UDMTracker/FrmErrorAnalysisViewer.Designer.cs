namespace UDMTracker
{
    partial class FrmErrorAnalysisViewer
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ucFlowResultViewer = new UDM.Project.UCFlowResultGanttViewer();
			...
			this.tabMain.SelectedTabPage = this.tpgDetectingResult;
        ...
        private UDM.Project.UCFlowResultGanttViewer ucFlowResultViewer;
