...
namespace UDM.EnergyDaq.Monitor
{
    public class CSerialPortRead:CThreadBase
    {
        ...
        protected CMeterDataRecorder m_cMeterLogger = new CMeterDataRecorder();
        ...
        public CMeterDataRecorder MonitorLogger
        {
        ...
        protected override bool BeforeRun()
        {
            ...
            m_cMeterDataReader.MeterDataRecorder = m_cMeterLogger;
        ...
        protected bool RunMonitorLogger()
        {
            ...
            if (m_cMeterLogger == null)
                m_cMeterLogger = new CMeterDataRecorder();
