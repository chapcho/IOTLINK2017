...
namespace UDM.EnergyDaq.Monitor
{
    public class CModbusRTUConnecter
    {
        ...
        public CMeterDataRecorder MeterDataRecorder
        {
            get { return m_cSerialPortConnecter.DataRecorder; }
            set { m_cSerialPortConnecter.DataRecorder = value; }
        }
        ...
        public bool ReadDataS()
        {
            ...
            {
                bool tempCheck = ReadMeterData(tempDeviceCon.SlaveIndex, tempDeviceCon.StartAddress, tempDeviceCon.WordCount,tempDeviceCon);
        ...
        private bool ReadMeterData(int iSlaveIndex, int iStartAddress, int iWordCount,CSerialDeviceConfig temDiviceCon)
        {
            ...
            bool bOK = m_cSerialPortConnecter.SeriaPortDataSend(bSendByteS,temDiviceCon);
