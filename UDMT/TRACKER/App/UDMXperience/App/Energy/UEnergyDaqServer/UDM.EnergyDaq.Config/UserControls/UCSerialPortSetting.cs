...
namespace UDM.EnergyDaq.Config
{
    public partial class UCSerialPortSetting : UserControl
    {
        ...
        protected FrmConfigSetting m_frParentFrm = null;

        public UCSerialPortSetting(FrmConfigSetting parent)
        {
            InitializeComponent();
            m_frParentFrm = parent;
        ...
        public CSerialPortConfig GetSerialPortConfgi()
        {
            ...
            foreach(CSerialDeviceConfig cTemp in m_lstSerialDeviceS)
            {
                cPortConfig.DeviceConfigList.Add(cTemp);
            }
        ...
        private void btnAddDevice_Click(object sender, EventArgs e)
        {
            ...
            cDeviceConfig.MeterDeviceKey = txtDeviceName.Text;
            ...
            cDeviceConfig.MeterModel = m_frParentFrm.GetMeterModel();
