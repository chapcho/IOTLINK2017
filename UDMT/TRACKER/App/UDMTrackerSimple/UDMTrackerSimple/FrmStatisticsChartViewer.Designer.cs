namespace UDMTrackerSimple
{
	partial class FrmStatisticsChartViewer
	{
		...
		private void InitializeComponent()
		{
			...
			this.ucCheckNavBarControl1 = new UDMTrackerSimple.UCCheckNavBarControl(this.components);
        ...
        series1};
			...
			this.ucCheckNavBarControl1.CheckedChaged += new UDMTrackerSimple.UCCheckNavBarControl.NavBarStateEventHandler(this.ucCheckNavBarControl1_CheckedChaged);
			// 
			// grRecoveryTimeInfo
			// 
