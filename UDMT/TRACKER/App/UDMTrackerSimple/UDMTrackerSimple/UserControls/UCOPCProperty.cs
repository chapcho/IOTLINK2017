...
namespace UDMTrackerSimple
{
	public partial class UCOPCProperty : UserControl
	{
		...
		public void ShowProperty()
		{
            ...
            spUdaterate.Value = m_cOPCConfig.UpdateRate;
			exProperty.Refresh();
		}
        ...
        private void cmbServerList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (m_cOPCConfig.ABOpc && m_sSelectedServer.Contains("Kepware.KEPServerEX.V5"))
                m_cOPCConfig.ABOpc = false;
        }
        ...
        private void spUdaterate_EditValueChanged(object sender, EventArgs e)
        {
            if(m_cOPCConfig !=null)
            {
                m_cOPCConfig.UpdateRate = (int)spUdaterate.Value;
            }
        }
	}
}
