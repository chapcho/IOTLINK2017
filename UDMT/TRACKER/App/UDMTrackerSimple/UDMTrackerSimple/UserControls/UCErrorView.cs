...
namespace UDMTrackerSimple
{
    public partial class UCErrorView : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private delegate void UpdateClearCallBack();
        ...
        private delegate void UpdateSetViewCallBack(CErrorInfoS cInfoS, CPlcProcS cProcess);
        ...
        public void SetErrorView(CErrorInfoS cErrorInfoS, CPlcProcS cProcessS)
        {
            ...
            {
                UpdateSetViewCallBack cUpdate = new UpdateSetViewCallBack(SetErrorView);
                this.Invoke(cUpdate, new object[] {cErrorInfoS, cProcessS});
            }
            else
            {
        ...
        public void InitialErrorView()
        {
            if (this.InvokeRequired)
            {
                UpdateClearCallBack cUpdate = new UpdateClearCallBack(InitialErrorView);
                this.Invoke(cUpdate, new object[] {});
            }
            else
            {
                m_ucErrorDetail.InitialDetailView();
            }
        }
        ...
        public void ClearControl()
        {
            if (this.InvokeRequired)
            {
                UpdateClearCallBack cUpdate = new UpdateClearCallBack(ClearControl);
                this.Invoke(cUpdate, new object[] {});
            }
            else
            {
