namespace UDMEnergyViewer
{
    partial class UCTagTable
    {
        ...
        private void InitializeComponent()
        {
			...
			this.colIsMonitor = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			// colIsMonitor
			// 
			this.colIsMonitor.AppearanceHeader.Options.UseTextOptions = true;
			this.colIsMonitor.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colIsMonitor.Caption = "Monitor";
			this.colIsMonitor.ColumnEdit = this.exEditorCheckBox;
			this.colIsMonitor.FieldName = "IsCollectUsed";
			this.colIsMonitor.MinWidth = 40;
			this.colIsMonitor.Name = "colIsMonitor";
			this.colIsMonitor.Visible = true;
			this.colIsMonitor.VisibleIndex = 0;
			this.colIsMonitor.Width = 40;
			// 
			// exEditorCheckBox
			// 
        ...
        private DevExpress.XtraGrid.Columns.GridColumn colIsMonitor;
