...
namespace UDM.Export
{
    ...
    public class eUIOStatusList
    {
        ...
        public static string ADDRESSNOTUSED = "ADDRESS NOTUSED";
        ...
        public static string LOGIC_DOUBLECOIL = "LOGIC DOUBLECOIL";
    ...
    public class eUIOStatus
    {
        ...
        public static string ERROR_ADDRESS_NOTUSED = "사용안됨";

        public static string ERROR_LOGIC_DOUBLECOIL = "이중코일";//"Redundancy Symbol";
    }
