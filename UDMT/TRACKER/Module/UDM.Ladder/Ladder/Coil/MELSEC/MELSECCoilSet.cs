...
{
    public static class MELSECCoilSet
    {
        ...
        public static void DrawAdditional(Graphics graphics, Point point, bool bValue, string strTime, CCoil cCoil, Font font, Brush brush, CTimeLogS cLogS)
        {
            try
            {
                ...
                // Size font SET
                sizeFont = graphics.MeasureString("SET", font);
                graphics.DrawString("SET", font, brushInfo, new PointF(point.X + 1 * segment, point.Y - (sizeFont.Height / 2f)), stringFormat);
