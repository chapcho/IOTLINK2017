...
{
    public static class ABCoilOutputLatch
    {
        ...
        private static void InitVertexes()
        {
            ...
            m_cVertexS.Add(new CVertex(-6, -13)); // 16
            m_cVertexS.Add(new CVertex(-6, 13)); // 17
            m_cVertexS.Add(new CVertex(6, 13)); // 18
        }
        ...
        private static void InitEdges()
        {
            try
            {
                ...
                m_cEdgeS.Add(new CEdge(m_cVertexS[16], m_cVertexS[17])); //2
                m_cEdgeS.Add(new CEdge(m_cVertexS[17], m_cVertexS[18])); //3
            }
