...
{
    public static class MELSECContactLogicalEGP
    {
        ...
        static MELSECContactLogicalEGP()
        {
            InitVertexes();
            InitEdges();
            InitPolygons();
        ...
        private static void InitVertexes()
        {
            ...
            m_cVertexS.Add(new CVertex(-15, -20)); // 4
            m_cVertexS.Add(new CVertex(15, 20)); // 5
            m_cVertexS.Add(new CVertex(-10, -5)); // 6
            m_cVertexS.Add(new CVertex(10, -5)); // 7
        }
        ...
        private static void InitEdges()
        {
            try
            {
                m_cEdgeS.Add(new CEdge(m_cVertexS[7], m_cVertexS[3])); //0
                m_cEdgeS.Add(new CEdge(m_cVertexS[3], m_cVertexS[6])); //1
                m_cEdgeS.Add(new CEdge(m_cVertexS[4], m_cVertexS[5])); //2
                m_cEdgeS.Add(new CEdge(m_cVertexS[0], m_cVertexS[1])); //3
                m_cEdgeS.Add(new CEdge(m_cVertexS[2], m_cVertexS[3])); //4
            }
