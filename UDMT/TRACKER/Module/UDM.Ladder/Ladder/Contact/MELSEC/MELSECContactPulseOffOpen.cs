...
{
    public static class MELSECContactPulseOffOpen
    {
        ...
        static MELSECContactPulseOffOpen()
        {
            InitVertexes();
            InitEdges();
            InitPolygons();
        ...
        private static void InitVertexes()
        {
            ...
            m_cVertexS.Add(new CVertex(0, -17)); // 12
            m_cVertexS.Add(new CVertex(10, 5)); // 13
            m_cVertexS.Add(new CVertex(-10, 5)); // 14
        ...
        private static void InitEdges()
        {
            try
            {
                ...
                m_cEdgeS.Add(new CEdge(m_cVertexS[15], m_cVertexS[12])); //4
                m_cEdgeS.Add(new CEdge(m_cVertexS[16], m_cVertexS[17])); //5
            }
        ...
        private static void InitPolygons()
        {
            try
            {
                ...
                polygon1.Add(m_cVertexS[15]);
                polygon1.Add(m_cVertexS[14]);
