...
{
    public static class MELSECContactLogicalMEP
    {
        ...
        static MELSECContactLogicalMEP()
        {
            InitVertexes();
            InitEdges();
            InitPolygons();
        ...
        private static void InitEdges()
        {
            try
            {
                m_cEdgeS.Add(new CEdge(m_cVertexS[5], m_cVertexS[3])); //0
                m_cEdgeS.Add(new CEdge(m_cVertexS[4], m_cVertexS[3])); //1
