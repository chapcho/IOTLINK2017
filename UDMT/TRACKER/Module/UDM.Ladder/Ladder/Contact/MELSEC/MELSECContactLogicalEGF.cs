...
{
    public static class MELSECContactLogicalEGF
    {
        ...
        static MELSECContactLogicalEGF()
        {
            InitVertexes();
            InitEdges();
            InitPolygons();
        ...
        private static void InitVertexes()
        {
            ...
            m_cVertexS.Add(new CVertex(-15, -20)); // 6
            m_cVertexS.Add(new CVertex(15, 20)); // 7
        }
        ...
        private static void InitEdges()
        {
            try
            {
                ...
                m_cEdgeS.Add(new CEdge(m_cVertexS[6], m_cVertexS[7])); //2
