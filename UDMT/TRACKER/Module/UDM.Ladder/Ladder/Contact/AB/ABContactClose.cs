...
{
    public static class ABContactClose
    {
        ...
        private static void InitVertexes()
        {
            ...
            m_cVertexS.Add(new CVertex(2, -12)); // 16
            m_cVertexS.Add(new CVertex(-2, 12)); // 17
        }
        ...
        private static void InitEdges()
        {
            try
            {
                ...
                m_cEdgeS.Add(new CEdge(m_cVertexS[16], m_cVertexS[17])); //7
                m_cEdgeS.Add(new CEdge(m_cVertexS[8], m_cVertexS[9])); //8
            }
        ...
        public static void DrawAdditional(Graphics graphics, Point point, bool bValue, CTag cTag, Font font, Brush brush)
        {
            // If value
            ...
            // String address
            SizeF sizeFont = graphics.MeasureString(cTag.Address, font);
            graphics.DrawString(cTag.Address, font, brush, new Point(point.X, point.Y - 20 - (int)Math.Round(sizeFont.Height)), stringFormat);       
        }
    }
}
