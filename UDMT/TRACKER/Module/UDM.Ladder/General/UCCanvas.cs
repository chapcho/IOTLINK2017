...
namespace UDM.UI
{
    ...
    public partial class UCCanvas : UserControl
    {
        ...
        public bool Debug { get { return m_bDebug; } set { m_bDebug = !value; this.DebugMode(); } }
        ...
        private void OnMouseWheelDefault(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            scale = m_scale + scale > 0.001 ? m_scale + scale : m_scale; // To avoid scale zero
        ...
        private void DownOnElement(float x, float y, System.Windows.Forms.MouseEventArgs e, Keys k)
        {
            ...
            if (k != Keys.Control) { m_hashElementsSelected.Clear(); }
