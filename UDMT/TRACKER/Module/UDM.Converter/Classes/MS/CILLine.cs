...
{
    [Serializable]
    public class CILLine : ICloneable
    {
        ...
        public CILLine(string strProgram, string strStep, string strNote, string strCommand, string strOperand, string[] arrOperandSub)
        {
        ...
        public bool CheckDoubleWord(List<string> lstCommandAll)
        {
            bool bDoubleWord = false;
            {
                if (m_sCommand.Contains("D"))
                {
                    ...
                    else if (arrCommand.Length == 4)    // DABDD
                    {
        ...
        public List<string> GetUsedAddress()
        {
            ...
            if (CPlcMelsec.IsAddress(Source))
                ListUsedAddress.Add(Source);
            if (CPlcMelsec.IsAddress(Source_Sub1))
                ListUsedAddress.Add(Source_Sub1);
            if (CPlcMelsec.IsAddress(Source_Sub2))
                ListUsedAddress.Add(Source_Sub2);
            if (CPlcMelsec.IsAddress(Source_Sub3))
                ListUsedAddress.Add(Source_Sub3);
            if (CPlcMelsec.IsAddress(Source_Sub4))
                ListUsedAddress.Add(Source_Sub4);
            if (CPlcMelsec.IsAddress(Destination))
                ListUsedAddress.Add(Destination);
            if (CPlcMelsec.IsAddress(Destination_Sub1))
                ListUsedAddress.Add(Destination_Sub1);
            if (CPlcMelsec.IsAddress(Destination_Sub2))
                ListUsedAddress.Add(Destination_Sub2);
            if (CPlcMelsec.IsAddress(Numeric))
                ListUsedAddress.Add(Numeric);
            if (CPlcMelsec.IsAddress(Numeric_Sub1))
                ListUsedAddress.Add(Numeric_Sub1);
            if (CPlcMelsec.IsAddress(Numeric_Sub2))
                ListUsedAddress.Add(Numeric_Sub2);
            if (CPlcMelsec.IsAddress(Numeric_Sub3))
        ...
        private void GenerationCommand(string strCommand)
        {
            ...
            m_eILImportType = CILImportType.GetType(strCommand);
        }
        ...
        private bool SetCall(string strOperand, string[] arrOperandSub)
        {
            ...
            m_sCommand = EMCoilImport.ProgramLabel.ToString();
